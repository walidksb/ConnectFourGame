...
class Play:
    ...
    #the computer turn is the minimax algorithm with alpha beta pruning
    ...
    def minimaxAlphaBetaPruning(self, depth, maximizingPlayer, alpha, beta):
        if depth == 3 or self.board.gameOver():
            return self.board.heuristicEval(2)
